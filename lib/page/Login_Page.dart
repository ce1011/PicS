  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      builder: (context) => Column(
        children: <Widget>[
          Text.rich(TextSpan(text: 'Log in to ', style: TextStyle(fontSize: 28), children: [
            TextSpan(
                text: "PicS",
                style: TextStyle(
                    fontSize: 32,
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  alternate_email, color: Color(0xFF2308423)),
                  labelText: "E-mail",
          ...
          Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    prefixIcon: Icon(Icons.vpn_key_outlined, color: Color(0xFF2308423)),
                    labelText: "Password",
                    enabledBorder: OutlineInputBorder(
                        borderSide: new BorderSide(color: Color(0xFF2308423))),
                    focusedBorder: OutlineInputBorder(
          ...
          RaisedButton(
            onPressed: () {
              Provider.of<LoginStateNotifier>(context, listen: false).login();
